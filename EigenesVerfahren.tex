...
Once the whole generating process is done, the model will appear in the world in the position where the Actor was spawned. The result of such a process can be seen in Figure \ref{fig:LoadedModel}.
